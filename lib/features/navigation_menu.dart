      ...
      bottomNavigationBar: Obx(
        () => NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(icon: Icon(Iconsax.teacher), label: 'Store'),
            NavigationDestination(icon: Icon(Iconsax.chart), label: 'Wishlist'),
            NavigationDestination(
                icon: Icon(Iconsax.personalcard), label: 'Settings'),
          ],
        ),
      ),
