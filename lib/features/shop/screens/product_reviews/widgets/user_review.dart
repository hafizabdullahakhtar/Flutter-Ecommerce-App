  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
          ...
          children: [
            Row(
              children: [
                ...
                Text('Jackline', style: Theme.of(context).textTheme.titleLarge),
              ],
            ),
        ...
        const ReadMoreText(
          'The user interface of app is quite intuitive. I was able to navigate and make purchases seemlesly, Great Job!',
          trimLines: 2,
